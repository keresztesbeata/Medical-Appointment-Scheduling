...
public class UrlAddressCatalogue {
    ...
    public static final String RECEPTIONIST_GET_ALL_PATIENTS = "/receptionist/patient_appointments/all";
    public static final String RECEPTIONIST_GET_ALL_DOCTORS = "/receptionist/patient_appointments/all";
